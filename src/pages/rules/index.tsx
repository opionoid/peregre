    ...
    <Rules>
      ...
      <Reveal animation={Animation.FadeInUp}>
        ...
        <section>
          ...
          <img style={{ display: 'block', margin: '0 auto' }} width={'400px'} src={SampleBoard} alt="sample board image" />
          <h3>ロケーション</h3>
          <p>ロケーションは「酒場」「神殿」「分岐路」といった名前が裏に印字されたカードで、表向きにすることで情報が得られます。ただし現在のフェーズのロケーションしか表向きにできません。ロケーションの選択は最大魂魄量の多い者ほど優先されますが、参加者は自身の選択順を最後に回すことができます。また、ロケーション自体に人数制限が定められていない限り、複数の参加者が同じロケーションを訪れることができます。</p>
          <p>
            ロケーションでは大まかに3種類のイベントが発生します。
          </p>
          <ul>
            <li>情報：情報が得られます。</li>
            <li>戦闘：戦闘が発生します。他のロケーションにいる参加者も1ターン遅れて参加できます。</li>
            <li>特殊：何かが発生します。</li>
          </ul>
          <p>なお、全てのロケーションは公開せずともかまいません。ロケーションは所有しているわけではないので譲渡・交換はできません。訪れたことのある参加者たちは、自身が望むタイミングでカードを再度確認できます。（PvP向けルール）</p>
          <h3>フェーズ</h3>
          <p>フェーズはロケーションの行の集合であり、ゲームの進行度を示すものでもあります。現在のフェーズに属するロケーションのみが選択でき、アビリティを除き過去や未来のフェーズには干渉できません。</p>
        </section>
      </Reveal>
      <hr />
      <Reveal animation={Animation.FadeInUp}>
